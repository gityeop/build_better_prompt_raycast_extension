...
`],["r","\r"],["t","	"],["b","\b"],["f","\f"],["v","\v"],["0","\0"],["\\","\\"],["e","\x1B"],["a","\x07"]]);function pe(e){let t=e[0]==="u",r=e[1]==="{";return t&&!r&&e.length===5||e[0]==="x"&&e.length===3?String.fromCharCode(parseInt(e.slice(1),16)):t&&r?String.fromCodePoint(parseInt(e.slice(2,-1),16)):tt.get(e)||e}function nt(e,t){let r=[],n=t.trim().split(/\s*,\s*/g),o;for(let s of n){let l=Number(s);if(!Number.isNaN(l))r.push(l);else if(o=s.match(Qe))r.push(o[2].replace(et,(c,a,u)=>a?pe(a):u));else throw new Error(`Invalid Chalk template style argument: ${s} (in style '${e}')`)}return r}function rt(e){ge.lastIndex=0;let t=[],r;for(;(r=ge.exec(e))!==null;){let n=r[1];if(r[2]){let o=nt(n,r[2]);t.push([n].concat(o))}else t.push([n])}return t}function de(e,t){let r={};for(let o of t)for(let s of o.styles)r[s[0]]=o.inverse?null:s.slice(1);let n=e;for(let[o,s]of Object.entries(r))if(Array.isArray(s)){if(!(o in n))throw new Error(`Unknown Chalk style: ${o}`);n=s.length>0?n[o](...s):n[o]}return n}be.exports=(e,t)=>{let r=[],n=[],o=[];if(t.replace(Je,(s,l,c,a,u,g)=>{if(l)o.push(pe(l));else if(a){let h=o.join("");o=[],n.push(r.length===0?h:de(e,r)(h)),r.push({inverse:c,styles:rt(a)})}else if(u){if(r.length===0)throw new Error("Found extraneous } in Chalk template literal");n.push(de(e,r)(o.join(""))),o=[],r.pop()}else o.push(g)}),n.push(o.join("")),r.length>0){let s=`Chalk template literal is missing ${r.length} closing bracket${r.length===1?"":"s"} (\`}\`)`;throw new Error(s)}return n.join("")}});var Oe=m((Ot,xe)=>{"use strict";var M=se(),{stdout:N,stderr:G}=ue(),{stringReplaceAll:ot,stringEncaseCRLFWithFirstIndex:st}=he(),{isArray:B}=Array,ve=["ansi","ansi","ansi256","ansi16m"],O=Object.create(null),lt=(e,t={})=>{if(t.level&&!(Number.isInteger(t.level)&&t.level>=0&&t.level<=3))throw new Error("The `level` option should be an integer from 0 to 3");let r=N?N.level:0;e.level=t.level===void 0?r:t.level},z=class{constructor(t){return we(t)}},we=e=>{let t={};return lt(t,e),t.template=(...r)=>Ce(t.template,...r),Object.setPrototypeOf(t,A.prototype),Object.setPrototypeOf(t.template,t),t.template.constructor=()=>{throw new Error("`chalk.constructor()` is deprecated. Use `new chalk.Instance()` instead.")},t.template.Instance=z,t.template};function A(e){return we(e)}for(let[e,t]of Object.entries(M))O[e]={get(){let r=$(this,V(t.open,t.close,this._styler),this._isEmpty);return Object.defineProperty(this,e,{value:r}),r}};O.visible={get(){let e=$(this,this._styler,!0);return Object.defineProperty(this,"visible",{value:e}),e}};var ke=["rgb","hex","keyword","hsl","hsv","hwb","ansi","ansi256"];for(let e of ke)O[e]={get(){let{level:t}=this;return function(...r){let n=V(M.color[ve[t]][e](...r),M.color.close,this._styler);return $(this,n,this._isEmpty)}}};for(let e of ke){let t="bg"+e[0].toUpperCase()+e.slice(1);O[t]={get(){let{level:r}=this;return function(...n){let o=V(M.bgColor[ve[r]][e](...n),M.bgColor.close,this._styler);return $(this,o,this._isEmpty)}}}}var ct=Object.defineProperties(()=>{},{...O,level:{enumerable:!0,get(){return this._generator.level},set(e){this._generator.level=e}}}),V=(e,t,r)=>{let n,o;return r===void 0?(n=e,o=t):(n=r.openAll+e,o=t+r.closeAll),{open:e,close:t,openAll:n,closeAll:o,parent:r}},$=(e,t,r)=>{let n=(...o)=>B(o[0])&&B(o[0].raw)?ye(n,Ce(n,...o)):ye(n,o.length===1?""+o[0]:o.join(" "));return Object.setPrototypeOf(n,ct),n._generator=e,n._styler=t,n._isEmpty=r,n},ye=(e,t)=>{if(e.level<=0||!t)return e._isEmpty?"":t;let r=e._styler;if(r===void 0)return t;let{openAll:n,closeAll:o}=r;if(t.indexOf("\x1B")!==-1)for(;r!==void 0;)t=ot(t,r.close,r.open),r=r.parent;let s=t.indexOf(`
`);return s!==-1&&(t=st(t,o,n,s)),n+t+o},q,Ce=(e,...t)=>{let[r]=t;if(!B(r)||!B(r.raw))return t.join(" ");let n=t.slice(1),o=[r.raw[0]];for(let s=1;s<r.length;s++)o.push(String(n[s-1]).replace(/[{}\\]/g,"\\$&"),String(r.raw[s]));return q===void 0&&(q=me()),q(e,o.join(""))};Object.defineProperties(A.prototype,O);var I=A();I.supportsColor=N;I.stderr=A({level:G?G.level:0});I.stderr.supportsColor=G;xe.exports=I});var gt={};Pe(gt,{renderResults:()=>ht});module.exports=Fe(gt);var f=_e(Oe());var it=e=>e==="meetsCriteria"?"":e.replace(/([A-Z])/g," $1").trim().split(" ").map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(" ");function Ee(e){if(typeof e=="string")return Ee({name:e});let t=`Calls Tool ${e.name}`;return e.arguments&&(t+=` with arguments ${Object.keys(e.arguments).join(", ")}`),t}var D=e=>{if("meetsCriteria"in e)return e.meetsCriteria;if("callsTool"in e)return Ee(e.callsTool);if("not"in e){let s=D(e.not).split(" ");return s[0].endsWith("s")&&(s[0]=s[0].slice(0,-1)),`Doesn't ${s.join(" ")}`}let t=Object.keys(e)[0],r=e[t],n=it(t);return r?`${n} "${r}"`:n};var v=100,w=e=>{let t=e.replace(/\u001b\[\d+m/g,"");return Array.from(t).reduce((r,n)=>r+(new RegExp("\\p{Emoji_Presentation}","u").test(n)?2:1),0)},Me=(e,t=75)=>e?w(e)<=t?e:e.slice(0,t)+"...":"";function at(e,t,r=" "){let n=w(e);return n>=t?e:e+r.repeat(t-n)}function ut(e,t,r=" "){let n=w(e);return n>=t?e:r.repeat(t-n)+e}function Re(e){let t=e.reduce((l,c)=>Math.max(l,w(c.name)),0),r=f.default.grey("\u250C"+"\u2500".repeat(t+2)+"\u252C"+"\u2500".repeat(v)+"\u2510")+`
...
`,e.status==="error")c+=Re([{name:"Error",content:s(e.error)}]);else if(e.status==="completed"){let g=[{name:"Criteria",content:e.expected.map((h,b)=>{let je=o[b]?.result===1,Te=D(h);return`${je?f.default.green("\u2714"):f.default.red("\u2718")} ${f.default.grey(Te)}`}).join(`
